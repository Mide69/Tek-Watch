    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-14">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-foreground text-sm tracking-tight">Tek Watch</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/overview"
              className="flex items-center gap-1.5 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
            >
      ...
      <section className="relative pt-20 pb-28 px-6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-indigo-500/6 dark:bg-indigo-600/10 rounded-full blur-3xl" />
        </div>

        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-indigo-500/30 bg-indigo-500/8 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-medium mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14">
            <Link
              href="/overview"
              className="flex items-center justify-center gap-2 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all shadow-md shadow-indigo-500/20 hover:shadow-indigo-500/30"
            >
      ...
      <section className="px-6 pb-20">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl border border-border bg-card overflow-hidden shadow-xl shadow-black/5 dark:shadow-black/50">
            {/* Mock browser chrome */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-muted/50">
              ...
              <div className="flex-1 mx-4">
                <div className="h-5 rounded-md bg-background border border-border w-72 mx-auto flex items-center justify-center">
                  <span className="text-xs text-muted-foreground">app.tekwatch.io/overview</span>
                </div>
              </div>
            </div>
            {/* Mock dashboard */}
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  { label: 'Total Resources',   value: '847',   color: 'text-blue-600 dark:text-blue-400',    bg: 'bg-blue-500/8 dark:bg-blue-500/10'    },
                  { label: 'Active Alarms',     value: '3',     color: 'text-red-600 dark:text-red-400',      bg: 'bg-red-500/8 dark:bg-red-500/10'      },
                  { label: 'Security Findings', value: '2',     color: 'text-amber-600 dark:text-amber-400',  bg: 'bg-amber-500/8 dark:bg-amber-500/10'  },
                  { label: 'Monthly Cost',      value: '$4.2k', color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-500/8 dark:bg-emerald-500/10' },
                ].map(s => (
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4">
                <div className="text-xs text-muted-foreground mb-3">Daily Spend — Last 30 Days</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={f.title} className={`rounded-xl border ${f.border} bg-card hover:bg-accent/30 p-5 transition-colors`}>
      ...
      <section id="how-it-works" className="px-6 py-20 border-t border-border">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg">No agents to build. No dashboards to configure.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="relative">
                {i < 2 && (
                  <div className="hidden md:block absolute top-6 left-[calc(100%+1rem)] w-8 text-border">
                    <ChevronRight className="w-5 h-5" />
                  </div>
                )}
                <div className="text-4xl font-bold text-muted/60 dark:text-muted-foreground/20 mb-3 select-none">{s.step}</div>
      ...
      <section id="pricing" className="px-6 py-20 border-t border-border">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Simple, predictable pricing</h2>
            <p className="text-muted-foreground text-lg">Per customer, per month. No surprise usage fees.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              {
              ...
              <div key={p.name} className={`rounded-2xl border p-6 relative ${
                p.highlight
                  ? 'border-indigo-500/40 bg-indigo-50 dark:bg-indigo-600/8 shadow-md shadow-indigo-500/10'
      ...
      <section className="px-6 py-20 border-t border-border">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/overview"
              className="flex items-center justify-center gap-2 px-8 py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all shadow-md shadow-indigo-500/20"
            >
              Launch Live Demo <ArrowRight className="w-4 h-4" />
            </Link>
            <a
      ...
      <footer className="px-6 py-8 border-t border-border bg-muted/30">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold text-foreground">Tek Watch</span>
            <span className="text-xs text-muted-foreground ml-1">by Tek Tribe Ltd</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2026 Tek Tribe Ltd. All rights reserved.</p>
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            <a href="mailto:support@tektribe.io" className="hover:text-foreground transition-colors">support@tektribe.io</a>
          </div>
        </div>
      </footer>
    </div>
